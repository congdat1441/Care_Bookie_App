...
class _HistoryListsClinicsState extends State<HistoryListsClinics> {
  ...
  void initState() {
    ...
    Future<List<History>> future = getAllHistoryByUserIdFirebase("88zfUPPgwLxGq9mRchRD");

  }
  
  @override
  Widget build(BuildContext context) {
    return Consumer2<HistoryPageProvider,UserLoginProvider>(
      builder: (context, historyPageProvider,userLoginProvider, child) => Container(
        width: MediaQuery.of(context).size.width,
        height: MediaQuery.of(context).size.height,
        child: FutureBuilder<List<History>>(
          future: historyPageProvider.getAllHistoryByUserId(userLoginProvider.userLogin.id),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                        histories[index].hospital.image,
                                        width: 130,
                                        height: 130,
                                        fit: BoxFit.fill,
                                        ),
                                    ...
                                    child: Column(
                                      children: [
                                        SizedBox(
                                            ...
                                            //height: 40,
                                            //color: Colors.grey,
                                            child: Text(histories[index].hospital.hospitalName,
                                                maxLines: 2,
                                          ...
                                          child: SizedBox(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(histories[index].diagnosis,
                                                      maxLines: 2,
                                                      overflow: TextOverflow.ellipsis,
                                                      style: const TextStyle(
                                                          height: 1,
                                                    ...
                                                    text: TextSpan(children: [
                                                      WidgetSpan(
                                                          child: Padding(
                                                            ...
                                                            child: Text(histories[index].appointment,
                                                                style: const TextStyle(
                                                                    letterSpacing: 0.2,
                                                                    fontSize: 13,
                                                                    color: ColorConstant.Grey01,
