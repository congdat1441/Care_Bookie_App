  ...
  Widget build(BuildContext context) {
    return Consumer2<HomePageProvider,HospitalDetailPageProvider>(
      builder: (context, homePageProvider,hospitalDetailPageProvider, child) => SizedBox(
        ...
        height: 500,
        child: homePageProvider.listHospital.isEmpty? const Center(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          ...
                          hospitalDetailPageProvider.setHospitalDetails(homePageProvider.listHospital[index]);
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(
                                  ...
                                  //height: 40,
                                  //color: Colors.grey,
                                  child: Text(homePageProvider.listHospital[index].hospitalName,
                                      maxLines: 2,
                              ...
                              Expanded(
                                ...
                                child: Row(
                                  children: [
                                    Text(homePageProvider.listHospital[index].workingHours,
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                        style: const TextStyle(
                                            height: 0.9,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(homePageProvider.listHospital[index].star.toString(),
                                          style: const TextStyle(
                                              height: 0.9,
                                              fontSize: 15,
                                              color: ColorConstant.Grey01,
